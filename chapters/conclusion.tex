...
Using the output of an early \acs{ADM} UNET Decoder layer exceeded expectation on the \acs{FPR} metrics performing much better than every other baseline considered in this thesis and \cite{jazbec_generative_2025}. 
