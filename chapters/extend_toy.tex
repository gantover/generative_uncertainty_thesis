...
For the remaining of our experiment, we will simply define the Deep Ensemble based Generative Uncertainty as the source of truth for uncertainty. In the next chapter, we compare cheaper ways to get the \acs{MC} ensemble of models against the Deep Ensemble (\acs{DE}).
