...
% \autoref{fig:classifier} shows that no improvement can be made to the FID, indeed, at 12000 images it has already been reduced to $FID \simeq 7$ which is much lower than what the sweet spot generative uncertainty filtering could offer on the classifier-free guided model ($FID \simeq 10$). 
