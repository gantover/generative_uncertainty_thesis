...
\usepackage[
 ...
 bgcolor=dtucoolgrey, % the colour of the tiles
...
\def\authors{
  {Damian B. Hubert / s243425},
  {Student No 2/Student ID 2},
  {Student No 3/Student ID 3},
  {Student No 4/Student ID 4}}
\def\myTitle{Generative Uncertainty Estimation in Diffusion Models\xspace}
\def\mySubtitle{Exploration and Improvements\xspace}
\def\myDegree{Master's Thesis\xspace}
\def\myShortNames{Damian B. Hubert\xspace}
...
\def\myDepartment{Department of Applied Mathematics and Computer Science\xspace}
\def\myUni{DTU University\xspace}
\def\myLocation{Lyngby\xspace}
...
% \usepackage{subfig} % conflicts with subcaption; chapters use \begin{subfigure} from subcaption instead
% ****************************************************************************************************
